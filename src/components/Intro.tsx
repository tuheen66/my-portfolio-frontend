  ...
  return (
    <section className="flex flex-col lg:flex-row items-center justify-center gap-6 p-6 bg-gray-100 dark:bg-gray-700 rounded-2xl shadow-lg">
      ...
      <div className=" max-w-xl">
        ...
        <Link href="https://drive.google.com/file/d/1aqXyIFsqQLiDj85E_jYLMROXEcAgaFcx/view?usp=sharing" target="_blank">
        <button className="text-white mt-2 bg-orange-600  px-4 py-2  flex items-center gap-4 rounded-lg">
          Download Resume
        </button>
        </Link>
      </div>
