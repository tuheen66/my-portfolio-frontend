...
const BlogCard = ({ blog }: { blog: TBlog }) => {
  ...
  return (
    <div className="flex-grow gap-8 bg-white dark:bg-slate-800 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-200 dark:border-slate-700">
      <div className="">
        <Image
          className="flex-grow w-full h-full  object-fit transition-transform duration-500 hover:scale-105"
          src={blog.image}
          width={500}
          height={500}
          alt={blog.title}
      ...
      <div className="p-6  flex flex-col justify-between flex-grow">
        <div>
          <div className=" flex flex-col gap-3 mb-3">
            <span className="px-3 py-1 bg-orange-200 dark:bg-orange-200 text-orange-600 dark:text-orange-600 text-xs font-semibold rounded-full w-fit">
              {blog.category}
            </span>
